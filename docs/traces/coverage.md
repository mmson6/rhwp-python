...
| v0.5.0/mcp | — | `tests/test_mcp_server.py::TestToolRegistry::test_lists_exactly_six_tools` |
| v0.5.0/mcp | AC-10 | `tests/test_mcp_server.py::TestPackagingSurface::test_module_is_top_level_not_under_integrations` |
| v0.5.0/mcp | AC-2 | `tests/test_mcp_server.py::TestToolRegistry::test_lists_exactly_six_tools` |
