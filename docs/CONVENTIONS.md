...
- ADR 파일: `<topic>-research.md` (roadmap spec `<topic>.md` 와 stem 일치). v0.2.0/v0.3.0 의 `<topic>-design-research.md` (`-design-` infix) 는 historical 패턴 — lint 가 grandfather 로 수용, **신규는 `-research.md` 만**
